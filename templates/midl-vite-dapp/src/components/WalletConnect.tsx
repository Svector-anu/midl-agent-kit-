...
/**
 * Connects using connectors configured in midl-config.ts.
 *
 ...
 *
 * NEVER pass ordinalsAccount.address as `from` in addTxIntention —
 * MIDL derives a different EVM address from the P2TR string.
 */
